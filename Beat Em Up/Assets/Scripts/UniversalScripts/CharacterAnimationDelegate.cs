...
{
    public GameObject left_Arm_Attack_Point, left_Leg_Attack_Point, 
        right_Arm_Attack_Point, right_Leg_Attack_Point;
    ...
    void DisableMovement()
    {
        ...
        // set the enemy parent to default layer to avoid detecting further collisions while down
